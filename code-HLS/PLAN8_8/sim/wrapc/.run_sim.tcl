...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sigmoid_plan.autotvin.dat"
	set constFileTvOut       "sigmoid_plan.autotvout.dat"
	set constFileHdlTvIn     "sigmoid_plan.autohdltvin.dat"
	set constFileHdlTvOut    "sigmoid_plan.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
