...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sigmoid_top.autotvin.dat"
	set constFileTvOut       "sigmoid_top.autotvout.dat"
	set constFileHdlTvIn     "sigmoid_top.autohdltvin.dat"
	set constFileHdlTvOut    "sigmoid_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
