...
if {[file isfile sigmoid_plan.autotvin.dat]} {
	file delete -force sigmoid_plan.autotvin.dat
}

if {[file isfile sigmoid_plan.autotvout.dat]} {
	file delete -force sigmoid_plan.autotvout.dat
}
