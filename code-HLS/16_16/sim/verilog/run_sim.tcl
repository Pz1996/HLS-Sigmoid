...
if {[file isfile sigmoid_top.autotvin.dat]} {
	file delete -force sigmoid_top.autotvin.dat
}

if {[file isfile sigmoid_top.autotvout.dat]} {
	file delete -force sigmoid_top.autotvout.dat
}
