...
open_solution "PLAN16_8_200m" -flow_target vivado
set_part {xc7k325t-ffg676-2}
create_clock -period 200MHz -name default
config_export -format ip_catalog -rtl verilog -vivado_clock 5 -vivado_phys_opt all
#source "./sigmoid_new/PLAN16_8_200m/directives.tcl"
csim_design
csynth_design
cosim_design
