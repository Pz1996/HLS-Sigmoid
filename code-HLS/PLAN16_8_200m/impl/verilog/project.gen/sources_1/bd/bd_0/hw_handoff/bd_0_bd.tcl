...
proc create_root_design { parentCell } {
  ...
  set in_r [ create_bd_port -dir I -from 15 -to 0 -type data in_r ]

  # Create instance: hls_inst, and set properties
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:sigmoid_plan:1.0 hls_inst ]
  ...
  connect_bd_net -net in_r_0_1 [get_bd_ports in_r] [get_bd_pins hls_inst/in_r]
