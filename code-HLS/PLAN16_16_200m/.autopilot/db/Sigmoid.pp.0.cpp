...
typedef ap_ufixed<16, 4> din_t;
typedef ap_fixed<16, 2> data_t;
typedef ap_ufixed<16, 1> dout_t;
typedef ap_uint<4> UINT4;

dout_t sigmoid_top(din_t in);
__attribute__((sdx_kernel("sigmoid_plan", 0))) dout_t sigmoid_plan(din_t in);
# 2 "Sigmoid.cpp" 2
...
#pragma HLS PIPELINE
 ...
 data_t x0;
 if(in >= 5) x0 = (data_t)1;
 else if(in >= 2.375) x0 = (in >> 5) + (data_t)0.84375;
 else if(in >= 1) x0 = (in >> 3) +(data_t)0.625;
 else x0 = (in >> 2) + (data_t)0.5;
 ...
 data_t ROM_EXP[16];
 VITIS_LOOP_18_1: for(int i=0; i<16; i++){
 ...
 UINT4 m = x_ln2_rev.range(16 -1, 16 -4);
 UINT4 n = x_ln2_rev.range(16 -5, 16 -4-4);
 din_t tmp;
 tmp.setBits(x_ln2_rev.range(16 -5-4,0));
 data_t j = tmp * _ln2;
...
__attribute__((sdx_kernel("sigmoid_plan", 0))) dout_t sigmoid_plan(din_t in){
#pragma HLS TOP name=sigmoid_plan
# 38 "Sigmoid.cpp"
...
# 50 "Sigmoid.cpp"
 din_t x0;
 if(in >= 5) x0 = (din_t)1;
 else if(in >= 2.375) x0 = (in >> 5) + (din_t)0.84375;
 else if(in >= 1) x0 = (in >> 3) +(din_t)0.625;
 else x0 = (in >> 2) + (din_t)0.5;
