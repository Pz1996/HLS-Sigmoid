...
entity sigmoid_plan_shl_16ns_16ns_16_3_1 is
    generic (
      ...
      NUM_STAGE : INTEGER := 3      --stage number
  );
    port (
      clk : IN STD_LOGIC;
      reset : IN STD_LOGIC;
...
end entity sigmoid_plan_shl_16ns_16ns_16_3_1;
architecture rtl of sigmoid_plan_shl_16ns_16ns_16_3_1 is
