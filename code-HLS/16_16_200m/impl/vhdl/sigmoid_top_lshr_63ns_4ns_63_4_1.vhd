...
entity sigmoid_top_lshr_63ns_4ns_63_4_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 63;  --data bitwidth
      din1_WIDTH : INTEGER := 63;    --shift control bitwidth
      dout_WIDTH : INTEGER := 63;  --output bitwidth
...
end entity sigmoid_top_lshr_63ns_4ns_63_4_1;
architecture rtl of sigmoid_top_lshr_63ns_4ns_63_4_1 is
